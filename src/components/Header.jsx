        ...
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-1 xl:gap-2">
            ...
            <div className="relative group">
              <button className="px-3 xl:px-4 py-2 text-white text-xs xl:text-sm font-medium hover:text-[#FF5722] transition-colors duration-200 flex items-center gap-1 whitespace-nowrap">
              ...
              <div className="absolute top-full left-0 mt-1 w-64 bg-white shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 rounded-md overflow-hidden">
                <Link
                  to="/courses/oil-and-gas-piping"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                  Oil and Gas Piping Engineering
                </Link>
                <Link
                  to="/courses/mechanical-qa-qc"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                  Mechanical QA/QC
                </Link>
                <Link
                  to="/courses/piping-and-pipeline"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                  Piping and Pipeline Engineering
                </Link>
                <Link
                  to="/courses/ndt-level-2"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                  NDT Level-II
                </Link>
                ...
                <Link
                  to="/courses/diploma-fire-safety"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                ...
                <Link
                  to="/courses/diploma-logistics-scm"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                  Diploma in Logistics & SCM
                </Link>
                <Link
                  to="/courses/diploma-welding-technology"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                  Diploma in Welding Technology
                </Link>
                <Link
                  to="/courses/certification-business-analyst-operation"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-1 w-56 bg-white shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 rounded-md overflow-hidden">
                <Link
                  to="/services/onsite-internship"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                  On-Site Internship
                </Link>
                <Link
                  to="/services/job-training"
                  className="block px-5 py-3 text-[#2C2C2C] hover:bg-[#FF5722] hover:text-white transition-colors duration-200"
                >
                  Job Training
                </Link>
      ...
      >
        <nav className="px-4 py-4 space-y-2">
          ...
          <div>
            ...
            <div
              className={`overflow-hidden transition-all duration-200 ${
                openDropdown === "courses" ? "max-h-[500px]" : "max-h-0"
              }`}
            >
              <Link
                to="/courses/oil-and-gas-piping"
                className="block px-8 py-2 text-gray-300 hover:text-[#FF5722] hover:pl-10 transition-all"
                onClick={() => setIsMenuOpen(false)}
              >
                Oil and Gas Piping Engineering
              </Link>
          ...
          <div>
            ...
            <div
              className={`overflow-hidden transition-all duration-200 ${
                openDropdown === "services" ? "max-h-48" : "max-h-0"
              }`}
            >
              <Link
                to="/services/onsite-internship"

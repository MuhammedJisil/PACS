...
const Footer = () => {
  ...
  const courses = [
    ...
    {
      name: "Diploma Welding Technology",
      path: "/courses/diploma-welding-technology",
    },
    {
      name: "Certification Business Analyst Operation",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 leading-relaxed text-sm">
              Making you into a professional and fine-tune your aptitude and
              communication skills and make you ready to crack any opportunity
              coming your way in core industries.
            </p>
          </div>
          ...
          <div>
              ...
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    First floor, Geekay tower, Opp. Omega hospital, Pumpwell,
                    Mangalore
                  </p>
                </div>
              </div>
            ...
            <div className="flex gap-4 mt-6">
             <a
                href="https://m.facebook.com/profile.php?id=100070019106592"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-orange-500 hover:to-orange-600 transition-all duration-300 group"
              >
                <svg
              ...
              <a
                href="https://www.instagram.com/pacs_training?igsh=MWRsaDdrZTlzMmg0bw=="
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/pacs-global/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-orange-500 hover:to-orange-600 transition-all duration-300 group"
              >

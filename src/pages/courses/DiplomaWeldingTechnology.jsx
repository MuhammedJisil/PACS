  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Master advanced welding techniques and technology with comprehensive training and certification at PACS Global."
        />
      </Helmet>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-base md:text-lg">
                <span className="font-bold text-gray-800">
                  PACS Global's Diploma in Welding Technology
                </span>{" "}
                program offers comprehensive training in advanced welding
                processes, metallurgy, welding inspection, and quality control.
                Our curriculum is designed to meet international welding
                standards and industry requirements.
              </p>

              <p className="text-base md:text-lg">
                Master multiple welding processes including SMAW (Shielded Metal
                Arc Welding), GMAW/MIG (Gas Metal Arc Welding), GTAW/TIG (Gas
                Tungsten Arc Welding), FCAW (Flux-Cored Arc Welding), and SAW
                (Submerged Arc Welding). Learn welding metallurgy, heat
                treatment, and material science.
              </p>

              <p className="text-base md:text-lg">
                The program covers welding design, joint preparation, welding
                procedures, NDT methods for weld inspection, welding defects
                identification, and quality assurance. You'll gain hands-on
                experience with state-of-the-art welding equipment in our fully
                equipped welding workshop.
              </p>

              <p className="text-base md:text-lg">
                Our experienced instructors are certified welding professionals
                with extensive industry experience from oil & gas, shipbuilding,
                construction, and manufacturing sectors. Students receive
                practical training on various materials including carbon steel,
                stainless steel, and aluminum.
              </p>

              <p className="text-base md:text-lg font-semibold text-gray-800">
                Join PACS Global and become a certified welding technologist.
                Our graduates secure positions as welding supervisors, welding
                inspectors, welding engineers, and quality control specialists
        ...
        >
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Master SMAW, GMAW/MIG, GTAW/TIG, FCAW, and SAW welding techniques
              with hands-on practice on various materials and positions.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn welding metallurgy, heat treatment, material selection,
              welding design principles, and joint preparation techniques.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Develop skills in welding inspection, NDT methods, defect
              identification, welding procedures, and quality assurance systems.
            </p>
          </div>
        </div>
      </div>

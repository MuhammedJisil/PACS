  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Achieve NEBOSH certification with world-class health and safety training at PACS Global. Recognized globally for safety professionals."
        />
      </Helmet>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-base md:text-lg">
                <span className="font-bold text-gray-800">
                  PACS Global's NEBOSH
                </span>{" "}
                training program offers the internationally recognized National
                Examination Board in Occupational Safety and Health
                certification. This prestigious qualification is valued by
                employers worldwide and opens doors to senior safety management
                positions.
              </p>

              <p className="text-base md:text-lg">
                The NEBOSH International General Certificate (IGC) covers
                essential health and safety principles, risk assessment, hazard
                control, workplace safety management systems, and regulatory
                compliance. Learn from accredited NEBOSH tutors with extensive
                industry experience.
              </p>

              <p className="text-base md:text-lg">
                Our comprehensive program includes the IG1 (Management of Health
                and Safety) and IG2 (Risk Assessment) units, preparing you
                thoroughly for the NEBOSH examinations. You'll gain practical
                knowledge applicable across all industries and geographical
                locations.
              </p>

              <p className="text-base md:text-lg">
                The course covers hazard identification, risk control measures,
                safety culture, accident investigation, workplace inspections,
                and development of effective safety policies. Students receive
                extensive study materials, mock tests, and examination guidance.
              </p>

              <p className="text-base md:text-lg font-semibold text-gray-800">
                Join PACS Global and achieve the NEBOSH qualification that is
                recognized in over 130 countries. Our proven track record of
                high pass rates ensures your success in becoming a globally
        ...
        >
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Master safety management systems, health and safety culture,
              organizational responsibilities, and legal frameworks for
              workplace safety.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn comprehensive risk assessment methodologies, hazard
              identification, control measures implementation, and workplace
              risk management.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Understand control of workplace hazards including chemical,
              physical, biological, ergonomic risks, and workplace transport
              safety.
            </p>
          </div>
        </div>

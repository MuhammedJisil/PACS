...
import mainImage from "../../assets/oilandgaspipe.jpg";
...
const OilAndGasPiping = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Oil and Gas Piping Engineering | PACS</title>
        <meta name="description" content="Master Oil and Gas Piping Engineering with industry-leading training and certification programs at PACS Global." />
      </Helmet>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            Master the art of piping design, analysis, and engineering in the oil & gas industry
          </p>
        </div>
      </div>
          ...
          >
            ...
            <div className="mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">
                Industry-Leading Piping Engineering Training
              </h2>
              ...
              <p className="text-xl md:text-2xl font-semibold text-orange-600 mb-6">
                Build your career in the oil & gas sector
              </p>
            </div>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-base md:text-lg">
                <span className="font-bold text-gray-800">PACS Global's Oil and Gas Piping Engineering</span> program is designed to equip you with comprehensive knowledge and practical skills required in the oil & gas industry. Our curriculum covers everything from basic piping principles to advanced design techniques.
              </p>

              <p className="text-base md:text-lg">
                Learn industry-standard software tools including CAESAR II, AutoCAD, and piping design applications. Our expert instructors bring real-world experience from major oil & gas projects across the globe.
              </p>

              <p className="text-base md:text-lg">
                The course covers piping stress analysis, layout design, material selection, pressure vessel design, and compliance with international codes like ASME, API, and ASTM. You'll gain hands-on experience through practical projects and case studies.
              </p>

              <p className="text-base md:text-lg">
                Our training methodology focuses on both theoretical concepts and practical applications. Students work on real-world scenarios, preparing them for immediate employment in refineries, petrochemical plants, and offshore facilities.
              </p>

              <p className="text-base md:text-lg font-semibold text-gray-800">
                Join PACS Global and launch your career in one of the most rewarding sectors of engineering. Our placement support ensures you connect with top oil & gas companies worldwide.
              </p>
            </div>
          </div>
          ...
          >
            <div className="relative">
              ...
              <div className="rounded-lg overflow-hidden shadow-2xl">
                <img 
                  src={mainImage}
                  alt="Oil and Gas Piping Engineering"
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        >
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-3">Piping Design & Layout</h3>
            <p className="text-gray-600 leading-relaxed">
              Master piping design principles, equipment layout, and 3D modeling using industry-standard software tools.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-3">Stress Analysis</h3>
            <p className="text-gray-600 leading-relaxed">
              Learn piping stress analysis techniques using CAESAR II and understand thermal expansion, support design, and flexibility analysis.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-3">Code & Standards</h3>
            <p className="text-gray-600 leading-relaxed">
              Gain expertise in international codes and standards including ASME B31.3, API, and ASTM for piping systems.
            </p>
          </div>
        </div>
      </div>

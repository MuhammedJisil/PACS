  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Become a certified Business Analyst with comprehensive training in business analysis, operations management, and process optimization at PACS Global."
        />
      </Helmet>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            Transform business operations with data-driven insights and
            strategic analysis
          </p>
        </div>
      </div>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-base md:text-lg">
                <span className="font-bold text-gray-800">
                  PACS Global's Certification in Business Analyst Operations
                </span>{" "}
                program equips you with essential skills in business analysis,
                process optimization, requirements gathering, and strategic
                planning. Our curriculum aligns with IIBA standards and industry
                best practices.
              </p>

              <p className="text-base md:text-lg">
                Master requirements elicitation techniques, business process
                modeling, data analysis, stakeholder management, and solution
                assessment. Learn industry-standard tools including MS Visio,
                JIRA, SQL, Excel analytics, and business intelligence platforms.
              </p>

              <p className="text-base md:text-lg">
                The program covers use case development, gap analysis, workflow
                optimization, agile methodologies, project management
                fundamentals, and effective communication strategies. You'll
                gain hands-on experience through real-world case studies and
                business scenarios.
              </p>

              <p className="text-base md:text-lg">
                Our experienced instructors are certified business analysts
                working in leading corporations across IT, finance, healthcare,
                and consulting sectors. Students develop critical thinking,
                problem-solving, and analytical skills essential for business
                analyst roles.
              </p>

              <p className="text-base md:text-lg font-semibold text-gray-800">
                Join PACS Global and launch your career as a certified Business
                Analyst. Our graduates secure positions in business analysis,
                operations management, process improvement, and consulting roles
        ...
        >
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Master requirements gathering, stakeholder analysis, business
              process modeling, use case development, and solution evaluation
              techniques.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn data analysis, SQL queries, Excel analytics, business
              intelligence tools, and data visualization for informed
              decision-making.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Develop skills in process improvement, gap analysis, workflow
              optimization, agile methodologies, and change management
              strategies.
            </p>
          </div>
        </div>

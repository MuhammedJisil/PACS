  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Become a certified NDT Level 2 professional with comprehensive Non-Destructive Testing training at PACS Global."
        />
      </Helmet>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            Advanced Non-Destructive Testing certification for quality assurance
            professionals
          </p>
        </div>
      </div>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-base md:text-lg">
                <span className="font-bold text-gray-800">
                  PACS Global's NDT Level 2
                </span>{" "}
                certification program provides comprehensive training in
                advanced non-destructive testing methods. Our curriculum is
                designed to meet ASNT SNT-TC-1A, ISO 9712, and PCN certification
                requirements, ensuring global recognition.
              </p>

              <p className="text-base md:text-lg">
                Master multiple NDT methods including Ultrasonic Testing (UT),
                Radiographic Testing (RT), Magnetic Particle Testing (MT),
                Liquid Penetrant Testing (PT), Eddy Current Testing (ET), and
                Visual Testing (VT). Learn interpretation, evaluation, and
                reporting of test results.
              </p>

              <p className="text-base md:text-lg">
                The program encompasses hands-on training with state-of-the-art
                NDT equipment, practical examination preparation, and extensive
                exposure to real-world defect identification scenarios. You'll
                develop expertise in calibration procedures, acceptance
                criteria, and industry codes.
              </p>

              <p className="text-base md:text-lg">
                Our certified instructors bring decades of industry experience
                from aerospace, oil & gas, power generation, manufacturing, and
                construction sectors. Students receive individualized attention
                and comprehensive support throughout the certification process.
              </p>

              <p className="text-base md:text-lg font-semibold text-gray-800">
                Achieve NDT Level 2 certification with PACS Global and access
                high-demand career opportunities worldwide. Our graduates work
                with leading organizations in quality control, inspection, and
        ...
        >
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Master ultrasonic testing techniques, calibration, thickness
              measurement, flaw detection, and advanced UT methods for various
              materials.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn X-ray and gamma ray radiography, film interpretation, image
              quality indicators, and radiation safety procedures.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Develop skills in Magnetic Particle Testing, Liquid Penetrant
              Testing, and Eddy Current Testing for surface and near-surface
              defect detection.
            </p>
          </div>
        </div>

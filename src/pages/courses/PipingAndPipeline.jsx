  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Master Piping and Pipeline Engineering with comprehensive training in design, installation, and maintenance at PACS Global."
        />
      </Helmet>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            Become an expert in pipeline design, installation, and integrity
            management
          </p>
        </div>
      </div>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-base md:text-lg">
                <span className="font-bold text-gray-800">
                  PACS Global's Piping and Pipeline Engineering
                </span>{" "}
                program offers comprehensive training in the design,
                installation, maintenance, and integrity management of pipeline
                systems. Our curriculum is aligned with global industry
                standards and best practices.
              </p>

              <p className="text-base md:text-lg">
                Master pipeline routing, hydraulic calculations, material
                selection, corrosion protection, and integrity assessment. Learn
                industry-standard software including AutoCAD Plant 3D, CAESAR
                II, and pipeline simulation tools used by leading engineering
                firms worldwide.
              </p>

              <p className="text-base md:text-lg">
                The course encompasses onshore and offshore pipeline systems,
                cross-country pipelines, distribution networks, and process
                piping. You'll gain expertise in pipeline construction methods,
                welding procedures, testing protocols, and compliance with ASME
                B31.4, B31.8, and international codes.
              </p>

              <p className="text-base md:text-lg">
                Our industry-experienced instructors provide hands-on training
                through real-world project scenarios, case studies, and
                practical exercises. Students develop skills in risk assessment,
                failure analysis, and pipeline integrity management programs.
              </p>

              <p className="text-base md:text-lg font-semibold text-gray-800">
                Launch your career with PACS Global and join the ranks of
                successful pipeline engineers working in oil & gas, water
                utilities, chemical processing, and infrastructure development
        ...
        >
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Master pipeline routing, hydraulic design, material selection, and
              design calculations using industry-standard software and
              methodologies.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn construction techniques, welding procedures, testing
              methods, and quality control for onshore and offshore pipeline
              projects.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Understand pipeline integrity, corrosion protection, risk
              assessment, inspection techniques, and maintenance strategies.
            </p>
          </div>
        </div>
      </div>

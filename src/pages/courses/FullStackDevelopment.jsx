  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Master Full Stack Web Development with comprehensive training in modern technologies and frameworks at PACS Global."
        />
      </Helmet>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-base md:text-lg">
                <span className="font-bold text-gray-800">
                  PACS Global's Full Stack Development
                </span>{" "}
                program offers comprehensive training in modern web development
                technologies. Learn to build complete web applications from
                scratch, covering both client-side and server-side development.
              </p>

              <p className="text-base md:text-lg">
                Master essential technologies including HTML5, CSS3, JavaScript,
                React.js, Node.js, Express.js, MongoDB, and RESTful API
                development. Gain hands-on experience with version control using
                Git and deployment on cloud platforms.
              </p>

              <p className="text-base md:text-lg">
                The curriculum covers responsive web design, modern JavaScript
                frameworks, database management, authentication and
                authorization, API integration, and best practices in software
                development. You'll work on real-world projects that mirror
                industry standards.
              </p>

              <p className="text-base md:text-lg">
                Our experienced instructors are working professionals from top
                tech companies. They provide mentorship, code reviews, and
                career guidance to ensure you're industry-ready. Learn agile
                methodologies, testing, debugging, and deployment strategies.
              </p>

              <p className="text-base md:text-lg font-semibold text-gray-800">
                Launch your tech career with PACS Global. Join thousands of
                successful developers who have transformed their careers through
                our comprehensive full stack development program and secure
                positions in leading IT companies.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Master HTML5, CSS3, JavaScript, React.js, responsive design, and
              modern UI/UX principles to create stunning user interfaces.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn Node.js, Express.js, RESTful APIs, authentication,
              server-side logic, and building scalable backend systems.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Gain expertise in MongoDB, MySQL, database design, cloud
              deployment, Git version control, and DevOps fundamentals.
            </p>
          </div>
        </div>
      </div>

...
import onsiteinternsip from "../assets/OnsiteInternship.jpeg";
  ...
  const trainingProcess = [
    {
      ...
      description:
        "We have a number of courses suitable for engineering graduates, Diploma holders and Higher secondary pass outs. The registered candidates can choose the most adequate training course provided in our institute.",
    },
    {
      step: "2",
      title: "Experience the best training ever",
      description:
        "Candidates registered in our institute can attend the training programmes (both online and regular batches) with the assistance of the best faculty members, having proper industrial as well as training experience.",
    },
    {
      step: "3",
      title: "Discover your dream job",
      description:
        "Pacs global, the best institute in Kerala and Karnataka, provides you excellent opportunities to enter into various industries like oil and gas technology fields, QA/QC civil and mechanical fields, MEP etc…",
    },
    {
      step: "4",
      title: "Choose the best career path",
      description:
        "As we provide proper assistance for your dream career, you can choose the best career path, that may lead to discover and reach success. We provide you timely updates regarding the opportunities.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Making you a professional, ready to crack the opportunities coming
            your way in core industries.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center p-8 rounded-xl bg-gray-50 hover:bg-gradient-to-br hover:from-orange-50 hover:to-blue-50 transition-all duration-300 transform hover:scale-105"
              >
      ...
      <section
        id="about"
        data-animate
        className={`py-20 bg-gray-50 transform transition-all duration-1000 delay-100 ${
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-sm font-bold text-orange-500 uppercase tracking-wider mb-2">
              Our Story
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="p-8 md:p-12">
                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  We are one of the best educational institution working since
                  2018, in Kerala and Karnataka. We provide best training &
                  certification in the field of Mechanical, Electrical, Civil
                  and Quality Management Engineering. We offer unique
                  opportunities to face challenges through our enriched
                  learning, academic excellence, professional training and
                  corporate exposure.
                </p>
                <p className="text-gray-700 text-lg leading-relaxed">
                  We deliver courses and examinations to all major industrial
                  sectors like oil & gas, Logistics, Mechanical, Civil and
                  Safety. If you are interested in pursuing a career in the oil
                  and gas industry in Kochi and Mangalore, our website can be a
                  valuable resource. We provide information on the top companies
                  in the region, as well as tips on how to prepare for
                  interviews and increase your chances of landing the job of
                  your dreams.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.map((course, index) => (
              <Link
                ...
                className="bg-gray-50 rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 flex flex-col"
              >
                {/* Course Image */}
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h4 className="text-xl font-bold text-gray-800 mb-3 min-h-[56px]">
                    {course.title}
                  </h4>
      ...
      <section
        id="nebosh"
        data-animate
        className={`py-20 bg-gradient-to-br from-orange-500 to-orange-600 text-white transform transition-all duration-1000 delay-300 ${
          visibleSections.has("nebosh")
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-10"
        }`}
      >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-6 opacity-90">
                In the safety and health industry, the NEBOSH course is highly
                employable. NEBOSH course at Pacs Global makes students possess
                strong knowledge and practical ability to manage workplace risks
                and dangers and prevent accidents and injuries…
              </p>
              <div className="space-y-2 mb-6">
                ...
                <p>
                  <span className="font-semibold">Eligibility:</span> +2/
                  Diploma/ B. Tech
                </p>
              </div>
              <Link
      ...
      <section
        id="training"
        data-animate
        className={`py-20 bg-gray-50 transform transition-all duration-1000 delay-400 ${
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We ensure the best training to the candidates registered in our
              institute. We are the best institute, providing mechanical
              engineering jobs in Kerala, in various engineering streams.
            </p>
          </div>
      ...
      <section
        id="cta"
        data-animate
        className={`py-20 bg-gradient-to-br from-blue-600 to-blue-700 text-white transform transition-all duration-1000 delay-500 ${
